...
// On appelle la fonction qui vérifie s'il y a une session en cours
...
// Système qui v compter le nombre total d'articles et le nombre total d'articles par catégorie
if (count($articles)) {
